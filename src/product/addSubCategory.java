    ...
    private  String addSubCategory (String SubCategoryName, String categoryName){
        ...
        if (SubCategoryName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany ="INSERT INTO  `saikiran_enterprises`.`sub-category` (`subcategory_id` ,`sub-category_name` ,`category_name`)VALUES (NULL ,  '"+SubCategoryName+"',  '"+categoryName+"');";
               // "INSERT INTO  `saikiran_enterprises`.`product-company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";
                //String sqlInsertProduct = "INSERT INTO  `saikiran_enterprises`.`category` (`category_id` ,`category_name`)VALUES (NULL ,  '"+companyName+"'); ";
