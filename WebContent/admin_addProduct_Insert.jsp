...
%>
        ...
        <%
            /*
        INSERT INTO  `saikiran_enterprises`.`products` (
`product_id` ,
`product-name` ,
`sub-category-name` ,
`category-name` ,
...
WHERE  `product-name` =  'Assassins Creed'
 ...
 INSERT INTO  `saikiran_enterprises`.`expenses` (
`expenses_id` ,
`product_id` ,
`product_name` ,
`price` ,
...
NULL ,  '2',  'Ayinga Movie ',  '123456', NOW( )
        ...
        */
            ...
            st.execute(insertQuery);
                ...
                st.executeUpdate(" INSERT INTO  `saikiran_enterprises`.`expenses` ("
                            +"`expenses_id` ,"
                            +"`product_id` ,"
                            +"`product_name` ,"
                            +"`price` ,"
